  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [Column(
          children: [
                  ...
                  return Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Image.asset(contents[i].image, height: getProportionateScreenHeight(386),),
                        SizedBox(height: getProportionateScreenHeight(36)),
                        Text(contents[i].title, style: mainTextStyle(), textAlign: TextAlign.center,),
                        SizedBox(height: getProportionateScreenHeight(40),),
                        Text(contents[i].description, style: subTextStyle(), textAlign: TextAlign.center,)
            ...
            Container(
              ...
              margin: const EdgeInsets.fromLTRB(0, 40, 0, 50), //get proportional screen
              ...
              child: TextButton(
                ...
                child: Text(currentIndex == contents.length -1? "CONTINUE": "NEXT", style: TextStyle(color: Colors.white, fontSize: 16),),
                onPressed: (){
        ...
        Align(alignment: Alignment.bottomLeft,child: SvgPicture.asset("assets/greenRectangle.svg", height: 170, width: 170,),),
        Align(alignment: Alignment.bottomRight,child: SvgPicture.asset("assets/greenRectangleRight.svg",height: 120, width: 120,),),
...
Container buildDot(int index)
  {
    return Container(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: Color(0XFF31990D)),
            );
  }
...
List<OnboardingContent> contents = [
  ...
  OnboardingContent(
    ...
    description: "Get affordable, healthy meal plans that are just right for you"
  ),
